...
import { fetchAPI, hexToRgb, waitTwoFrames, WCGACheckColor } from "./utils"
...
const App: React.FC = () => {
  ...
  const avatar = `https://cdn.discordapp.com/avatars/${data?.id}/${data?.avatar}.webp?size=256&${data?.avatar?.startsWith("a_") ? "animated=true" : ""}`
  const banner = `https://cdn.discordapp.com/banners/${data?.id}/${data?.banner}.webp?${data?.banner?.startsWith("a_") ? "animated=true&size=2048" : "size=4096"}`
  ...
  return (
    <main>
      ...
      <section>
        ...
        <Lanyard
          id={DISCORD_ID}
          loaded={(state) => setLoadingState((prevState) => ({ ...prevState, lanyard: state }))}
          setKV={setKV}
        />

        <article className="bio">
          <p>
            I'm a <Age date={BIRTHDAY} /> junior full-stack developer at{" "}
            <Anchor href="https://designveloper.com/">Designveloper</Anchor> and a CS undergraduate at fit@
            <Anchor href="https://en.hcmus.edu.vn/">hcmus</Anchor>. Starting as a self-taught developer and have been
            coding since 2021, my expertise focuses mainly on web & app development.
            <br />
            <br />
            Outside of work, I enjoy playing rougelite and hack-n-slash games (as seen from my{" "}
            <Anchor href="https://steam.flupjamin.dev">Steam</Anchor> profile), and listening to <i>whatever</i> doesn't
            make my ears bleed. You can see the songs I'm listening to or the games I'm playing{" "}
        ...
        <article>
          ...
          <div className="icons">
            <Anchor
              href="mailto:contact@flupjamin.dev"
              title="Mail"
            ...
            <Anchor
              href={`https://discord.flupjamin.dev`}
              title="Discord"
              data-tooltip-id="tooltip"
            ...
            <Anchor
              href="https://twitter.flupjamin.dev"
              title="Twitter"
              data-tooltip-id="tooltip"
            ...
            <Anchor
              href="https://github.flupjamin.dev"
              title="GitHub"
              data-tooltip-id="tooltip"
